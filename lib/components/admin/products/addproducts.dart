...
import 'package:tdvpnext/utility/header.dart';
...
class CreateNewProductPage extends StatefulWidget {
  ...
  const CreateNewProductPage({Key? key,required this.docStock, required this.categoryModel})
      : super(key: key);
...
class _CreateNewProductPageState extends State<CreateNewProductPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('เพิ่มสินค้า ในกลุ่ม ${categoryModel.categoryname}'),
      ),
